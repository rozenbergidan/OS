...
#define PGROUNDUP(sz) (((sz) + PGSIZE - 1) & ~(PGSIZE - 1)) // round a size up to a multiple of PGSIZE
#define PGROUNDDOWN(a) (((a)) & ~(PGSIZE - 1))              // round a address down to a multiple of PGSIZE
